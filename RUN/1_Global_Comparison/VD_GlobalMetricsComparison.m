...
%%% VD_Variables: file saving the output of this script
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 1:m
    totalW_cl(i)=(sum(sum(conn_clean(:,:,7,i))));
end

for i = 1:m
    totalW_un(i) = (sum(sum(conn_unclean(:,:,7,i))));
end
...
for i = 1:m
   AvConnW_cl(i)=  mean(nonzeros(conn_clean(:,:,7,i))); %squareform
end

for i = 1:n
    AvConnW_un(i) = mean(nonzeros(conn_unclean(:,:,7,i)));
end
...
save (UndergraduateThesis/2_Node_Level_Differences/Output_Global/'VD_Variables')
