%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WEIGHT: Number of Streamlines - NOS (1).
% PURPOSE:
...
%%% NOS_Variables: file saving the output of this script
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
m = size(conn_clean(:,:,1,:),4);
n = size(conn_unclean(:,:,1,:),4);
...
for i = 1:m
    totalW_cl(i)=(sum(sum(conn_clean(:,:,1,i))));
end

for i = 1:m
    totalW_un(i) = (sum(sum(conn_unclean(:,:,1,i))));
end
...
for i = 1:m
   AvConnW_cl(i)=  mean(nonzeros(conn_clean(:,:,1,i))); %squareform
end

for i = 1:n
    AvConnW_un(i) = mean(nonzeros(conn_unclean(:,:,1,i)));
end
...
save (UndergraduateThesis/2_Node_Level_Differences/Output_Global/'NOS_Variables')
