...
%%%%%%%%% Info %%%%%%%%%%%
%%% FD_Variables - Output from Global Analyses
...
%%% FD_Node_Out_A - Output from local NON-normalized analyses
...
load ('FD_Variables',  'C_local_rand_cl', 'C_local_rand_un')

%--- Loading data generated in LOCAL non-normalized anayses
load ('FD_Node_Out_A', 'LocalClustering_cl', 'LocalClustering_un')
...
save('FD_Clust_Norm_Local_Output')
