...
%%%%%%%%% Info %%%%%%%%%%%
%%% FA_Variables - Output from Global Analyses
...
load ('FA_Variables',  'C_local_rand_cl', 'C_local_rand_un')

%--- Loading data generated in LOCAL non-normalized anayses
load ('FA_Node_Out_A', 'LocalClustering_cl', 'LocalClustering_un')
...
save('FA_Clust_Norm_Local_Output')
