...
%%%%%%%%% Info %%%%%%%%%%%
%%% VD_Variables - Output from Global Analyses
...
%%% VD_Node_Out_A - Output from local NON-normalized analyses
...
load ('VD_Variables',  'C_local_rand_cl', 'C_local_rand_un')

%--- Loading data generated in LOCAL non-normalized anayses
load ('VD_Node_Out_A', 'LocalClustering_cl', 'LocalClustering_un')
...
save('VD_Clust_Norm_Local_Output')
