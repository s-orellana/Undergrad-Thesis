...
load ('MD_Variables',  'E_local_rand_cl', 'E_local_rand_un')

%--- Loading data generated in LOCAL non-normalized anayses
load ('MD_Node_Out_A',  'LocalEfficiency_un', 'LocalEfficiency_cl')
...
save('MD_EFFI_Norm_Local_Output')
