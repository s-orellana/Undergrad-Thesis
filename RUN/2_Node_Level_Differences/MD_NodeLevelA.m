...
%%%%%%%%% Info %%%%%%%%%%%
%%% MD_Node_Out_A - stores the outputs of this script
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
WeAreAt_LocalE_CL =  i
WHERE = 'MD' %tell me where the script is at
end
...
save (UndergraduateThesis/2_Node_Level_Differences/Output_Local/'MD_Node_Out_A.mat')
